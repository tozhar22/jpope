...
class AdminEdit extends StatefulWidget {
  ...
  const AdminEdit({Key? key, required this.event}) : super(key: key);

  @override
  State<AdminEdit> createState() => _AdminEditEventState();
}

class _AdminEditEventState extends State<AdminEdit> {
                          ...
                          onPressed: () async {
                            ...
                            if (_formKey.currentState!.validate()) {
                              ...
                              if (userId != null) {
                                ...
                                print("id de user : ${editedEvent.organizerId}");
                                ...
                                String previousStatus = editedEvent.status; // Stocke le statut précédent

                                try {
                                  await collectionEvenementCree.update({
                                    ...
                                    'organizerId': editedEvent.organizerId!,
                                  });
